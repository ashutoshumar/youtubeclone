import { CHANNEL_VIDEO_FAIL, CHANNEL_VIDEO_REQUEST, CHANNEL_VIDEO_SUCCESS, HOME_VIDEOS_FAIL, HOME_VIDEOS_REQUEST, HOME_VIDEOS_SUCCESS, RELATED_VIDEO_FAIL, RELATED_VIDEO_REQUEST, RELATED_VIDEO_SUCCESS, SEARCHED_VIDEO_FAIL, SEARCHED_VIDEO_REQUEST, SEARCHED_VIDEO_SUCCESS, SELECTED_VIDEO_FAIL, SELECTED_VIDEO_REQUEST, SELECTED_VIDEO_SUCCESS, SUBSCRIPTIONS_CHANNEL_FAIL, SUBSCRIPTIONS_CHANNEL_REQUEST, SUBSCRIPTIONS_CHANNEL_SUCCESS } from "../actionType"
...
export const relatedVideoReducer=(state={
    ...
    videos:[],   
       ...
       switch(type)
       {
           ...
           case RELATED_VIDEO_SUCCESS:return{
               ...state,
               videos:payload,
               loading:false,
   ...
   export const searchedVideosReducer=(state={
    ...
    activeSearch:null ,  
       ...
       switch(type)
       {
           case SEARCHED_VIDEO_REQUEST:return{
               ...state,
               loading:true,
           }
